...
amr.load_weights('./checkpoint/post_submission/'+args.modelname+'/model')
...
input=[flowvar,xz]
#u_p, v_p, p_p, nu_p , idx, _ = amr.predict(input,batch_size=args.batchsize,verbose=1,workers=40, use_multiprocessing=True)
